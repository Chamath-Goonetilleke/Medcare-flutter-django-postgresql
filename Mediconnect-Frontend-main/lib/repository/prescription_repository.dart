...
class PrescriptionRepository {
  Future<dynamic> createPrescription({required String prescription}) async {
    try {
      var response = await http.post(
        Uri.parse("http://13.49.21.193:8000/api/prescriptions/create/"),
  ...
  Future<dynamic> createMedicine({required String medicine}) async {
    try {
      var response = await http.post(
        Uri.parse("http://13.49.21.193:8000/api/medicines/create/"),
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8'
        },
        body: medicine,
  ...
  Future<dynamic> createKeywords({required String keyword}) async {
    try {
      var response = await http.post(
        Uri.parse("http://13.49.21.193:8000/api/keywords/create/"),
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8'
        },
        body: keyword,
